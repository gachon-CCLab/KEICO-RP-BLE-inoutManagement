...
#class cmdChrc():
    # Run root
    # Change it: UUID of RP. Characteristic which is used when Android connect to (previously connected) device
    CMD_UUID = 'a7bc8017-4e40-48b2-822b-a1a7098163c1'
...
class MotorService(Service):
    # Change it: UUID of RP. It can be found in Android App.
    DKDK_SVC_UUID = 'a7bc8017-4e40-48b2-822b-a1a7098163c1'
